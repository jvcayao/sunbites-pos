    ...
    <SectionWrapper title="Inventory">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        ...
        <KpiCard
          ...
          accent={kpis.low_stock_count > 0 ? "warning" : "default"}
        />
        <KpiCard
          label="Out of Stock"
          value={kpis.out_of_stock_count}
          accent={kpis.out_of_stock_count > 0 ? "danger" : "default"}
        />
        <KpiCard
          label="Most Restocked"
          value={kpis.most_restocked_item ?? "—"}
          sub={
            kpis.most_restocked_item
              ? `${kpis.most_restocked_count}× restocked`
              : undefined
          }
