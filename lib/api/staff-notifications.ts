...
export const staffNotificationApi = {
  unreadCount: () =>
    apiClient.get<StaffUnreadCountResponse>(
      "/staff/notifications/unread-count",
    ),

  list: (params?: { page?: number; per_page?: number }) =>
    apiClient.get<StaffNotificationListResponse>("/staff/notifications", {
      params,
    }),
  ...
  destroy: (id: string) => apiClient.delete<void>(`/staff/notifications/${id}`),
